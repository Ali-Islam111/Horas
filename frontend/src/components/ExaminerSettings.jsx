      ...
      <header className="relative z-50 border-b border-white/5 bg-slate-950/50 backdrop-blur-2xl px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-white text-xl font-bold tracking-tight">{t('examiner.dashboard.nav.settings')}</h1>
              <p className="text-slate-400 text-sm">{t('examiner.settings.welcomeDesc')}</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-8 overflow-x-auto no-scrollbar">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 py-4 text-sm font-semibold transition-colors relative ${tab.id === 'examinerSettings' ? 'text-purple-400' : 'text-slate-400 hover:text-slate-200'}`}
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                {tab.icon}
              </svg>
              {tab.label}
              {tab.id === 'examinerSettings' && (
